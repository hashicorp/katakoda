The telephone numbers in Switzerland is consisted of 10 digits: **`0xx xxx xx xx`**. The first 3 digits are for the national destination codes (NDC) and 7 digits for the subscriber number.
